...
//				printf("impulse.m_drift = %f,%f,%f\n",impulse.m_drift.getX(),impulse.m_drift.getY(),impulse.m_drift.getZ());
    ...
    // KT - softbody collision callback
    typedef void (*myKtSoftBodyCollisionCallback)(btSoftBody*, btRigidBody*, btVector3);
    myKtSoftBodyCollisionCallback soft_collision_cb;
